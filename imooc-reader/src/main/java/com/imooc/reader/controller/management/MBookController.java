...
public class MBookController {
    ...
    public Map createBook(Book book){
        ...
        try{
            ...
            book.setEvaluationScope(0f);
            Document doc = Jsoup.parse(book.getDescription());//解析图片详情
            Element img = doc.select("img").first(); //获取图书详情第一张图的元素的对象
    ...
    public Map updateBook(Book book){
        ...
        try {
            ...
            rawBook.setSubName(book.getSubName());
